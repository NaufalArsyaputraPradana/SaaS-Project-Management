...
export default function PromoPopups() {
  ...
  return (
    <>
      ...
      {showSmall && (
        <div className="fixed bottom-6 left-6 z-[60] w-80 hidden sm:block animate-in slide-in-from-bottom-8 fade-in duration-500">
      ...
      {showLarge && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center backdrop-blur-sm bg-black/60 p-4 animate-in fade-in duration-500">
          <div className="relative w-full max-w-2xl bg-[#0a0a0f] border border-blue-500/30 rounded-3xl p-8 md:p-12 shadow-2xl shadow-blue-900/50 overflow-hidden animate-in zoom-in-95 duration-500">
            {/* Glow background */}
